...
def test_advanced_effects():
    ...
    print("   [+] Colorful particles burst when notes START playing")
    print("   [+] Particles fade out smoothly over time")
    print("   [+] Effects happen directly on the notes, not playhead")
    print()
    print("2. KEYBOARD ANIMATION (DRAMATICALLY ENHANCED)")
    print("   [+] Piano keys press down 30+ pixels (was 8px)")
    print("   [+] Brightness increases dramatically when pressed")
    print("   [+] Deep shadows (120+ alpha) show key depression")
    print("   [+] Thicker borders when pressed for extra contrast")
    print("   [+] Fast, pronounced animations - clearly noticeable")
    print()
    print("3. BLOOM/GLOW EFFECT")
    print("   [+] Bright radiant glow around active notes")
    print("   [+] Multiple layers create bloom effect")
    print("   [+] Happens directly on playing notes")
    print()
    print("IMPORTANT CHANGES:")
    print("   [-] Playhead line/arrow REMOVED completely")
    print("   [+] All visual effects now happen on the notes themselves")
    print("   [+] No clutter - cleaner, more focused visualization")
    print()
